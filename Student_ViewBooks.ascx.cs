...
public partial class Student_ViewBooks : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            cmd1.CommandText = "select Name from tblBook";
            ...
            cmd1.CommandText = "select distinct Category from tblBook";
    ...
    protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            DropDownList3.Items.Add("--Select Subject--");
            cmd3.CommandText = "select distinct Subject from tblBook where Category=@c";
            cmd3.Parameters.AddWithValue("@c", DropDownList2.SelectedItem.Text);
            SqlDataReader dr3 = db3.executeread(cmd3);
            while (dr3.Read())
            {
                String sub = dr3[0].ToString();
                DropDownList3.Items.Add(sub);
            }
        }
    }
